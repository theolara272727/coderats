...
The flask server is just for test. To configure the website, put your friends username on the "handles" array on script.js, along with the unix timestamp from the start date of your competition!.
